...
class FrameFateArk(StandardFrame):
    ...
    def __init__(self) -> None:
        ...
        self._blob_hash_holder = FateArkBlobHashHolder(fateark_core)
    ...
    def set_launch_data(
        self, serverNumber, password: str, fbToken: str, auth_server_url: str
    ):
    ...
    def launch(self):
        ...
        sn = str(self.serverNumber)
        auth_code = f"DomainGame:{sn}" if not sn.isdigit() else sn
    ...
    def blobHashHolder(self):
        return self._blob_hash_holder
